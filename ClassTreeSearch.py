...
from LeafBuffer import LeafBuffer
...
class TreeSearch:
    def __init__(self, args: dict, game, terminal_check, model):
        ...
        self.tree = Tree(self.num_table, self.num_node, self.num_child)
        # Circular buffer to collect leaf info and batch leaf positions
        self.leaf_buffer = LeafBuffer(game, args.get('buffer_size'), args.get('batch_size'))
